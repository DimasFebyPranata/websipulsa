  ...
  <div class="modal-body">
    <form id="form">
      ...
      <div class="form-group">
        ...
        <select name="provider" id="provider" class="form-control select2" required></select>
      </div>
      <div class="form-group">
        <label>Pulsa</label>
        <select name="pulsa" id="pulsa" class="form-control select2" required></select>
      </div>
      <div class="form-group">
        <label>Harga</label>
      ...
      <div class="form-group">
        <label>Stok</label>
        <input type="text" class="form-control" placeholder="Stok" name="stok" value="50" readonly>
      </div>
...
<script>
  ...
  var kategoriSearchUrl = '<?php echo site_url('provider_produk/search') ?>';
  var satuanSearchUrl = '<?php echo site_url('pulsa_produk/search') ?>';
</script>
